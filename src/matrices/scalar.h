...
#define CSCALAR_INIT_ZERO                                                                          \
  { 0.0, 0.0 }

#define CSCALAR_RE(a) ((a).re)
#define CSCALAR_IM(a) ((a).im)

#define CASSIGN_SCALAR(a, real, imag)                                                              \
  {                                                                                                \
    (a).re = (real);                                                                               \
    (a).im = (imag);                                                                               \
  }
#define CACCUMULATE_SCALAR(a, real, imag)                                                          \
  {                                                                                                \
    (a).re += (real);                                                                              \
    (a).im += (imag);                                                                              \
  }
#define CACCUMULATE_DIFF_SCALAR(a, real, imag)                                                     \
  {                                                                                                \
    (a).re -= (real);                                                                              \
    (a).im -= (imag);                                                                              \
  }
